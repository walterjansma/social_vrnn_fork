...
args.model_path = home + '/social_vrnn_fork' + '/trained_models/' + args.model_name + "/" + str(args.exp_num)
...
# Load Map Parameters
map_params = os.path.join(home + args.data_path + args.scenario, 'map.json')
